         ...
         {!navBar ?
            ...
            <>
               <Box sx={styles.leftMenuMainContainer}>
                  <Box sx={{
                     backgroundSize: 'contain', left: 0, "&:hover": { cursor: 'pointer', opacity: 0.8 }
                  }}>
                     <Text bold title style={{ color: Colors.darkBlue, borderBottom: `2px solid ${Colors.darkBlue}`, paddingBottom: 3 }}>PORTIFOLIO</Text>
            ...
            <>
               ...
               <Box sx={styles.menuResponsive}>
                  <Box sx={{
                     left: 0, "&:hover": { cursor: 'pointer', opacity: 0.8 }
                  }}>
                     <Text bold title style={{ color: Colors.darkBlue, borderBottom: `2px solid ${Colors.darkBlue}`, paddingBottom: 3 }}>PORTIFOLIO</Text>
                  </Box>
                  ...
                  <>
                     <Box sx={styles.menuMobileContainer}>
                        <Box sx={{
                           ...
                           <Text bold title style={{ color: Colors.darkBlue, paddingBottom: 3 }}>PORTIFOLIO</Text>
                        </Box>
